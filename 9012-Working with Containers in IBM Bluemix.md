...
You can create the Dockerfile by using your preferred CLI editor or a text editor on your computer. The Dockerfile is provided for you here.

1.Change directories to the cf-ic-<your initials> directory that you just created. Enter the following command to download the Dockerfile:
   ```
   git clone https://github.com/bluemix-enablement/ic179012.git
   ```
   A directory is created that is callled ic179012

 2. Copy the Dockerfile to the directory that you created earelierby entering the following command:
    ```
    cp ic179012/Dockerfile .
    ```

<div class="page-break"></div>
3. Enter the following command to view the Dockerfile:
...
4. Get your namespace. <pre><code> cf ic namespace get </pre></code>
...
5. Initialize the Bluemix Containers CLI
